class StartCli < Formula
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/start9labs/start-cli/releases/download/v0.3.6-alpha13/start-cli-aarch64-unknown-linux-gnu"
      sha256 "4b65a34ede46f87d2a46d7c5ada30ff8782d3a40ec9417a2ce7832fc902409e6"
    else
      url "https://github.com/start9labs/start-cli/releases/download/v0.3.6-alpha13/start-cli-x86_64-unknown-linux-gnu"
